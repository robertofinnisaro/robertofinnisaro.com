...
draft: false
cover:
    image: /assets/img//3d-printing/ideamaker.png
...
permalink: /3d-printing/ideamaker-calibration/
layout: post
---
...
![Printer settings menu](/assets/img/3d-printing/printer-settings.png "Printer settings located in IdeaMaker")

![Changing the value of the Extruder Steps in IdeaMaker](/assets/img/3d-printing/e-calibration.png "Changing the value of the Extruder Steps in IdeaMaker")
...
![Changing the flow rate value for a filament](/assets/img/3d-printing/flowrate.png "Changing the flow rate of the current filament selected")
...
The calibration method on other slicers uses a fork of the [gaaZolee smart temperature tower](https://www.thingiverse.com/thing:2729076), however if you want to save time you can download this [pre-set tower](/assets/zip/Temperature-Calibration-Tower.zip).
...
![Smart temperature tower](/assets/img/3d-printing/temp-tower.png "Smart temperature tower")
...
![Changing individual layers by adding custom parameters](/assets/img/3d-printing/temp-layer.png "Changing the individual layers by adding in custom parameters")
...
![Adding temperature for the left extruder](/assets/img/3d-printing/temp-temp.png "Adding temperature for the left extruder")

![Setting the temperature for the left extruder](/assets/img/3d-printing/temp-set.png "Setting the temperature for the left extruder")
...
![Setting the new temperature in the filament profile](/assets/img/3d-printing/fila-temp.png "Setting the new temperature in the filament profile")
...
You can also download a retraction file from [here](/assets/zip/Retraction-Calibration-Tower.zip).

![Retraction tower in IdeaMaker](/assets/img/3d-printing/retraction-tower.png "Retraction tower in IdeaMaker")

![Adding the retraction material amount to layer settings](/assets/img/3d-printing/retraction-layer.png "Adding the retraction material amount to layer settings")

![Changing the retraction amount depending on the layer selected](/assets/img/3d-printing/retraction-set.png "Changing the reaction amount depending on the layer selected")

To update the retraction value, navigate to:

`Advanced settings -> Extruder -> Retraction Material Amount`

![Setting the new retraction amount in the filament profile](/assets/img/3d-printing/fila-retract.png "Setting the new retraction amount in the filament profile")
...
![Changing the coasting value in filament settings](/assets/img/3d-printing/coasting.png "Changing the coasting value in filament settings")
...
![Changing the top and bottom flow rate](/assets/img/3d-printing/top-bottom-fr.png "Changing the top and bottom flow rate")
...
![Adjusting the XY compensation for over/under expansion](/assets/img/3d-printing/xy-compensation.png "XY compensation for over/under expansion")
...
![Adjusting the XY compensation for holes](/assets/img/3d-printing/xy-compensation-holes.png "XY compensation for hole adjustments")